...
proto:
	protoc --go_out=. --go-grpc_out=. --experimental_allow_proto3_optional proto/messenger.proto
	mv github.com/kuzin57/grpc-chat/server/internal/generated/*.pb.go server/internal/generated/
	rm -rf github.com internal

proto-python:
	python3 -m grpc_tools.protoc --proto_path=proto --python_out=./client --grpc_python_out=./client --experimental_allow_proto3_optional proto/messenger.proto
